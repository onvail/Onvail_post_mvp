...
import {AuthError, LoginProps, SignInProps, UserType} from 'src/types/authType';
...
const NewLogin: FunctionComponent<Props> = ({navigation}) => {
  ...
  return (
    <ImageBackground
      ...
      <TouchableOpacity
        ...
        style={tw`w-11/12 self-center rounded-12 border border-[#ffffff] self-center mt-12 py-4.5`}>
