...
const CommentCards: FunctionComponent<{
     ...
     const commentsRenderItem: ListRenderItem<Comments> = useCallback(({ item }) => {
          return (
               <RowContainer style={tw`flex-1 min-h-9 max-h-14 w-[80%] border border-red`}>
                    <Avatar.Text
          ...
          <View style={tw`flex-1 py-3 px-4`}>
               <RowContainer style={tw`flex-1 flex-row pr-5 justify-between`}>
                    ...
                    <TouchableOpacity onPress={() => handleLike()} style={tw``}>
                         <Icon icon={"heart"} color={isLiked ? Colors.red : "gray"} size={20} />
                    </TouchableOpacity>
               </RowContainer>
               <View style={tw`ml-10 flex-1`}>
                    <RowContainer style={tw`flex-1`}>
                         ...
                         <TouchableOpacity onPress={toggleReplyFieldVisibility} style={tw` ml-5`}>
                              <RowContainer>
