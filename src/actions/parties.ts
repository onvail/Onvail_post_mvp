...
export const likeComment = async (partyId: string, commentId: string, userId: string) => {
...
export const unlikeComment = async (partyId: string, commentId: string, userId: string) => {
     const commentDoc = doc(db, `party/${partyId}/comments/${commentId}`);
